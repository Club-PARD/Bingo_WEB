...
function WorkspaceView() {
    ...
    return (
        <Div flexDirection="row" width="100%" height="100%">
            ...
            <Div flexDirection="column" height="100%" width="100%">
                ...
                <Div height="80%" width="100%">
                    ...
                    <Div width="53%" height="100%" alignItems="center" flexDirection="column">
                        {/*retrospectlist top*/}
                        <Div
                            width="83%"
                            height="9%"
                        ...
                        <Div width="550px" height="833px" overflow="auto" justifyContent="center">
